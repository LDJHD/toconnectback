...
export const createPackValidator = vine.compile(vine.object({
...
export const addPackItemValidator = vine.compile(vine.object({
    packId: vine.number().positive(),
    articleId: vine.number().positive(),
    quantite: vine.number().min(1),
}));
//# sourceMappingURL=pack_validator.js.map