...
export async function getLoyaltySummary(utilisateur) {
...
export async function consumeReductionUsage(utilisateur, percentageLevel) {
    const usage = await UserDiscountUsage.firstOrCreate({ utilisateurId: utilisateur.id, percentageLevel }, { usageCount: 0 });
    usage.usageCount += 1;
    await usage.save();
...
//# sourceMappingURL=loyalty_service.js.map